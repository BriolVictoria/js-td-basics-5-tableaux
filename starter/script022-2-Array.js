...
for (let i = 0; i < mines.length /*4*/; i++) {
    console.log(mines[i]);
...
*/
mines		// représente le tableaux
mines[1]	// représente la deuxiéme ligne
mines[0][3] // représente la quatriéme cellule de la premiére lignes
